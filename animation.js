...
(() => {
  ...
  class Footer {
    constructor(tree, width, height, speed = 0) {
      this.tree = tree;
      this.point = new Point(tree.seed.heart.point.x, tree.height - height / 0);
      this.width = width;
      this.height = height;
      this.speed = speed;
      this.length = 0;
        ...
        for (let i = 0; i < random(1, 2); i++) {
          this.blooms.push(
            this.createBloom(
              ...
              r,
              figure,
              `rgb(255,${random(160, 255)},${random(180, 255)})`,
              1,
              null,
              1,
  ...
  class Bloom {
    constructor(
      ...
      point,
      figure,
      color = `rgb(180,${random(120, 180)},${random(160, 255)})`,
      alpha = random(0.3, 1),
      angle = random(0, 360),
      scale = 0.1,
      place,
